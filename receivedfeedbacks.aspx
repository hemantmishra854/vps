<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="receivedfeedbacks.aspx.cs" Inherits="WebApplication2.WebForm24" %>
    ...
    <div class="container">
        <div class="row mr-1 mr-md-0 mb-5">
            <div class="col-12 m-auto col-md-6">
                <h3 class="text-primary text-center">Feedbacks Given By The Users</h3>
            </div>
        </div>
        <div class="row mr-1 mr-md-0 mb-5">
