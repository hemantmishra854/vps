<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="issuevisa.aspx.cs" Inherits="WebApplication2.WebForm25" 
    ...
    <div class="offset-md-3 col-md-6 container-fluid mb-5" style="margin-top: 60px; background-color: #efeeee; border: solid 2px #f6dede;">
        <div class=" row form-group align-items-start mr-1">
            <div class="col-12 m-auto  pt-3">
                <h3 style="color: blue ;text-align:center">Send Confirmation Message To The User</h3>
            </div>
        </div>
