<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="appliedusers.aspx.cs" Inherits="WebApplication2.WebForm21" %>
    ...
    <div class="container">
        <div class="row mr-1 mr-md-0 mb-5">
            <div class="col-12 m-auto col-md-6">
                <h3 class="text-primary text-center">Users Applied For Visa </h3>
            </div>
        </div>
        <div class="row mr-1 mr-md-0 mb-5">
